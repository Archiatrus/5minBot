...
struct TypeData
{
    ...
    size_t							 mineralCost	 = 0;	  // mineral cost of the item
    size_t							 gasCost		 = 0;		  // gas cost of the item
    size_t							 supplyCost	  = 0;	   // supply cost of the item
    size_t							 buildTime	   = 0;		// build time of the item
	bool							isUnit		  = false;
