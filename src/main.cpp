...
int main(int argc, char* argv[])
{
	std::vector<std::string> maps = { "RedShift.SC2Map", "16BitLE.SC2Map", "LostAndFoundLE.SC2Map", "DarknessSanctuaryLE.SC2Map", "AcidPlantLE.SC2Map", "DreamcatcherLE.SC2Map", "CatalystLE.SC2Map"};
