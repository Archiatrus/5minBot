...
void BaseLocation::setTownHall(const sc2::Unit * townHall)
{
	...
	sc2::Units resources = m_bot.Observation()->GetUnits(sc2::Unit::Alliance::Neutral, sc2::IsUnits({ sc2::UNIT_TYPEID::NEUTRAL_MINERALFIELD , sc2::UNIT_TYPEID::NEUTRAL_MINERALFIELD750, sc2::UNIT_TYPEID::NEUTRAL_RICHMINERALFIELD, sc2::UNIT_TYPEID::NEUTRAL_RICHMINERALFIELD750}));
	m_minerals.clear();
	for (auto & resource : resources)
	{
